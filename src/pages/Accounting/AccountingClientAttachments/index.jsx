...
const AccountingClientAttachments = () => {
  ...
  useEffect(() => {
    document.title = "Recruitment - Client Attachments";
    refetch(filter);
  ...
  const columns = [
    ...
    {
      title: "File Type",
      render: (record) => <div className="text-grey">{record.type}</div>,
    },
    {
      title: "Actions",
      render: (record) => (
  ...
  return (
    ...
    >
      {isModalOpen && (
        <AccountingClientAttachmentForm
...
export default AccountingClientAttachments;
